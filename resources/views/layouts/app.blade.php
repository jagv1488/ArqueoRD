...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ config('app.name', 'ArqueoRD') }} | Bitácora Privada</title>
    ...
    <body class="font-sans antialiased text-stone-800 bg-[#FDF9F2]">
        <div class="min-h-screen">
            @include('layouts.navigation')

            @isset($header)
                <header class="bg-white shadow-sm border-b border-[#E6DBCB]">
